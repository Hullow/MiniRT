...
/*   Updated: 2025/06/05 17:27:22 by fallan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_matrix	rt_rotation(t_tuple norm)
{
	...
	new_y = norm;// the norm is our desired Y-AXIS
	if (is_equal_float(0, rt_magnitude(rt_cross_product(new_y, rt_vector(1, 0, 0))))) // if vectors are parallel
