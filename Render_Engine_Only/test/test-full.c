...
// A  0.2                                       255,255,255
// C  0,4.5,-12            0,-0.35,1             60
// sp  -0.5,1,0.5          2                    25,255,127
// pl  0,0,0               0.0,1.0,0.0          255,230,230

	// light
	scene.lux = rt_light(rt_color(255, 255, 255), rt_point(0, 0, -15.0), 1);

	// ambient
	ambient.color = rt_color(255, 255, 255);
	ambient.intensity = 0.2;

	// camera
	camera.coord = rt_point(-0.5, 1, 0.5);
	camera.orient = rt_point(0, -0.35, 1);
	...
	// sphere
	sphere_1 = rt_sphere(rt_color(25 * 255, 255 * 255, 127 * 255));
